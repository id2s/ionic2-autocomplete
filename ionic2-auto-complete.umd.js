(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs/util/noop'), require('rxjs/Observable'), require('rxjs/Subject'), require('rxjs/observable/fromPromise'), require('ionic-angular')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs/util/noop', 'rxjs/Observable', 'rxjs/Subject', 'rxjs/observable/fromPromise', 'ionic-angular'], factory) :
	(factory((global['ionic2-auto-complete'] = {}),global.core,global.common,global.forms,global.noop,global.Observable,global.Subject,global.fromPromise,global.ionicAngular));
